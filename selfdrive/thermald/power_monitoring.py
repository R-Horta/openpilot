...
VBATT_PAUSE_CHARGING = 10.2           # Lower limit on the LPF car battery voltage = # last value = 11 - trying to keep the car running even with the Corolla's ridiculous 45ah battery
