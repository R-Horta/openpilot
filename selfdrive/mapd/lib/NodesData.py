...
_MAX_LAT_ACC = 2.7  # Maximum lateral acceleration in turns. # Attempted to increase speed for turns when "Enable Map Data Turn Control" is selected. = old value =2.5, original value = 2.3
