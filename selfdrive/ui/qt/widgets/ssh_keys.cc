...
# test predetermined ssh test - old value - "SSH Keys", "", "Warning:..."
SshControl::SshControl() : ButtonControl("SSH Keys", "R-Horta", "Warning: This grants SSH access to all public keys in your GitHub settings. Never enter a GitHub username other than your own. A comma employee will NEVER ask you to add their GitHub username.") {
